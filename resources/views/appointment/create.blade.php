<x-app-layout>
    ...
    <form method="POST" action="{{ route('appointment.store') }}" class="max-w-lg mx-auto">
        ...
        @if(session('success'))
        <div class="mt-6 bg-green-100 text-green-700 p-2 rounded">
            {{ session('success') }}
        </div>
        @endif
    </form>
